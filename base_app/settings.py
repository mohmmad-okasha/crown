...
SECRET_KEY = 'django-insecure-9n8d&q(v3+=^ttq&e5zo76+uy$p%dne2u=^cs-yy@f2z*m*-n2'
...
DATABASES = {
    ...
    'logs_db': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'logs/logs_db.sqlite3',
    }
...
DATABASE_ROUTERS = ['base_app.routers.Log_db_Router']
