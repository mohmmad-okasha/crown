                    ...
                    <div class="modal-body">
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                ...
                                <select id="airline" v-model="booking.room_id" v-on:change="get_room_info(booking.room_id)"
...
export default {
    ...
    watch: {
        ...
        // 'booking.room_id': function (newValue) {
    ...
    methods: {
        ...
        get_room_info(value) {
            return axios({
                method: "get",
                url: domain_url + "/backend/get_room_info/", params: { room_id: value, hotel: this.booking.hotel },
                auth: { username: "admin", password: "123", },
            }).then((response) => (this.booking.room_type = response.data.type, this.room_id_id = response.data.id, this.get_room_range(response.data.range)));
        },
        ...
        async row_click(index) {
            ...
            await this.get_room_info(this.booking.room_id);
